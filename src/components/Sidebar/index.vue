...
<template>
  <aside
    ...
    :style="props.isMobile ? 'right: 0;' : 'right: 0;'"
  >
    <!-- Mobile Header with Logo -->
    <div v-if="props.isMobile" class="flex justify-between items-center mb-6 pt-2 pb-4 border-b border-gray-200 dark:border-slate-600">
    ...
    <nav :class="[
      ...
      'text-sm font-medium text-right flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent dark:scrollbar-thumb-slate-600'
    ]">
