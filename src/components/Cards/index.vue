    ...
    <div class="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-2xl p-6 transition-colors duration-300">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        <div
          ...
          :key="card.id"
          class="bg-white dark:bg-slate-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-6 transition-all duration-300 hover:border-blue-300 dark:hover:border-blue-600 hover:shadow-xl hover:-translate-y-1 group"
        >
          <!-- Card Header -->
          ...
          <div class="space-y-3 mb-6">
            <!-- License ID -->
            <div>
              <label class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide">شناسه لایسنس</label>
              <div class="mt-1 font-mono text-sm bg-gray-100 dark:bg-slate-700 px-3 py-2 rounded-lg border border-gray-200 dark:border-slate-600">
            ...
            <!-- Card Model -->
            <div>
              <label class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide">مدل کارت</label>
              <div class="mt-1 font-mono text-sm bg-gray-100 dark:bg-slate-700 px-3 py-2 rounded-lg border border-gray-200 dark:border-slate-600">
          ...
          <div class="flex items-center justify-between mb-6">
            <div>
              <span
                class="inline-flex items-center px-3 py-1 rounded-full text-xs font-bold shadow-lg"
                :class="[
                  card.status === 'active'
          ...
          <div class="flex gap-2">
            <router-link
              ...
              class="flex-1 px-4 py-2 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-xl hover:from-blue-600 hover:to-blue-700 transition-all duration-300 font-medium shadow-lg hover:shadow-xl flex items-center justify-center gap-2"
              title="ویرایش"
            >
            ...
            <button
              @click="viewQR(card)"
              class="px-3 py-2 bg-green-100 text-green-700 hover:bg-green-200 rounded-xl transition-all duration-300 hover:scale-105"
              title="مشاهده QR"
            >
            ...
            <button
              ...
              class="px-3 py-2 bg-red-100 text-red-700 hover:bg-red-200 rounded-xl transition-all duration-300 hover:scale-105"
              title="حذف"
            >
