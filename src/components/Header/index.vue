        ...
        <transition name="fade">
          <div v-if="isProfileOpen" :class="profileDropdownClasses">
            ...
            <ul :class="['text-right', isMobileDetected ? 'text-base' : 'text-sm']">
              <li>
                <a href="#" :class="['flex items-center justify-between hover:bg-gray-50 dark:hover:bg-slate-700 transition-colors duration-300', isMobileDetected ? 'px-6 py-6' : 'px-6 py-4']">
